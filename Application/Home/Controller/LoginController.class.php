...
class LoginController extends HomeController
{
	...
	{
		parent::_initialize();	$allow_action=array("index","test","register","upregister","loginsubmit","apiLogin","loginout","findpwd","findpaypwd","webreg","loption","setlang","lhelp","sendcode","smsend","faemail","findsendcode","resetpwd","sms_send");
	...
	public function apiLogin($a = "") 
	{
		$post = $_POST;
		var_dump($post,$_REQUEST,$a, input(""));
		exit("????");
	}
