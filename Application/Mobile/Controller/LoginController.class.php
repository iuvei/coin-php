...
class LoginController extends MobileController
{
	protected function _initialize()
	{
		...
		parent::_initialize();	$allow_action=array("index","register","apiLogin","upregister","loginsubmit","loginout","findpwd","findpaypwd","webreg","loption","setlang","lhelp","sendcode","findsendcode","smsend","resetpwd",'registers',"sms_send");
	...
	public function apiLogin($email=null,$lpwd=null,$vcode=null){
...
if($type == 2){
	...
	public function emailsend($desc_content, $toemail){	
	    ...
	    $config = $clist = M("config")->where(array('id'=>1))->field("smsemail,smtpdz,emailcode,smstemple")->find();
