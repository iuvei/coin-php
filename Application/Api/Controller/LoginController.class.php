...
class LoginController extends MobileController
{
	...
	{
		// exit("?");
		parent::_initialize();	$allow_action=array("index","register","","upregister","loginsubmit","loginout","findpwd","findpaypwd","webreg","loption","setlang","lhelp","sendcode","findsendcode","smsend","resetpwd",'registers',"sms_send");
