...
// exit("1");
// ————————————————
// 版权声明：本文为CSDN博主「10年老码农」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。
// 原文链接：https://blog.csdn.net/u011383596/article/details/128518494
...
// 定义数据库名
define('DB_NAME', 'biuser');
// 定义数据库账号
define('DB_USER', 'root');
// 定义数据库密码
define('DB_PWD', 'a123456');
// 定义数据库端口
define('DB_PORT', '3305');
